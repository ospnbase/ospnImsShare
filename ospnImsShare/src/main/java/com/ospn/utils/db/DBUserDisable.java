...
@Slf4j
public class DBUserDisable extends DBBase {
    public static String sql =
            "CREATE TABLE IF NOT EXISTS t_user_disable " +
    ...
    public DBUserDisable(ComboPooledDataSource data){
        super(data);
    }
    ...
    public UserData readUserByID(String user) {
        ...
        try {
            String sql = "select * from t_user_disable where osnID=?";
    ...
    public boolean insert(UserData userData) {
        ...
        ResultSet rs = null;
        try {
            String sql = "insert into t_user_disable (" +
    ...
    public boolean delete(String osnID) {
        ...
        ResultSet rs = null;
        try {
            String sql = "delete from t_user_disable where osnID=?";
            connection = comboPooledDataSource.getConnection();PerUtils.writeDB();
            statement = connection.prepareStatement(sql);
